module Transient_CrankNicolson_AffineFEStateMap
...
a(t, u, v, α) = ∫(α * exp(-t) * (∇(v) ⋅ ∇(u)))dΩ
l(t, v, α) = ∫(v * f(t))dΩ

# Test
op = TransientLinearFEOperator((t,u,v)->a(t,u,v,αh), (t,dtu,v)->m(dtu,v,αh), (t, v)->l(t, v, αh), U, V)
...
# Crank-Nicolson
ts = collect(t0:Δt:tF);
A(tₙ,tₙ₋₁,uₙ,v,(α,uₙ₋₁)) = 1/(tₙ-tₙ₋₁)*m(uₙ, v, α) + 1/2*a(tₙ,uₙ,v,α)
B(tₙ,tₙ₋₁,v,(α,uₙ₋₁)) = 1/2*l(tₙ,v,α) + 1/2*l(tₙ₋₁,v,α) + 1/(tₙ-tₙ₋₁)*m(uₙ₋₁, v, α) - 1/2*a(tₙ₋₁,uₙ₋₁,v,α)

# AffineFEStateMaps
V_αuₙ₋₁(tₙ₋₁) = MultiFieldFESpace([V_α,U(tₙ₋₁)])
αuₙ₋₁_to_uₙ(tₙ,tₙ₋₁) = AffineFEStateMap((u,v,p)->A(tₙ,tₙ₋₁,u,v,p),(v,p)->B(tₙ,tₙ₋₁,v,p),U(tₙ),V,V_αuₙ₋₁(tₙ₋₁),
